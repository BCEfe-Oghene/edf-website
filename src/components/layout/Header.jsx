...
function Header() {
      ...
      <div className="header__topbar">
        <div className="container header__topbar-inner">
          <div className="header__topbar-left">
            <a href="tel:+2347032860750" className="header__topbar-item">
            ...
            <a href="tel:+2347032860750" className="header__topbar-item">+234 70 32860750</a>
            <a href="mailto:info@edffoundation.org" className="header__topbar-item header__topbar-email">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              ✉ info@edffoundation.org
            </a>
          </div>
  ...
  <img src={logo} alt="Efe-Oghene Development Foundation (EDF)" />
                  ...
                  <div className="header__dropdown">
                    <div className="header__dropdown-inner">
                      <div className="header__dropdown-header">
                        <h4>{item.label === 'Programmes' ? 'EDF Programmes' : item.label}</h4>
                        <p>{item.label === 'Programmes' ? 'Education, WASH, Healthcare and Community Development initiatives.' : 'Be a part of change and make an impact.'}</p>
                      </div>
          ...
          <div className="header__actions">
            ...
            <Link to="/contact" className="btn btn-outline header__Partner With Us-btn">
              Partner With Us
