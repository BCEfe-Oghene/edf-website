...
import edfVideoPlaceholder from '../../assets/edf-video-placeholder.png';
      ...
      <div className="volunteer-section">
        <div className="container volunteer-section__inner">
          <div className="volunteer-section__content">
            <span className="section-tag section-tag--white">JOIN OUR MOVEMENT</span>
            <h2 className="volunteer-section__title">
              Become a Volunteer
Build Stronger Communities
            </h2>
            <p className="volunteer-section__desc">
              Join Efe-Oghene Development Foundation and use your skills, passion, and time to improve education, healthcare, WASH, humanitarian response, research, and community empowerment across Nigeria.
            </p>
  ...
  <img
    src={edfVideoPlaceholder}
    alt="Efe-Oghene Development Foundation"
