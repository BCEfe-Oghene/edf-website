        ...
        <div className="latest-news__header">
          <div>
            ...
            <p className="section-subtitle">
              Explore our latest news, field stories, press releases, and moments of impact from across Nigeria and beyond.
            </p>
          </div>
        </div>
              ...
              <div className="social-post">
                <div className="social-post__header">
                  <div className="social-post__author">
                    ...
                    <strong>@edffoundation.org</strong>
                  </div>
              ...
              <div className="social-post">
                <div className="social-post__header">
                  <div className="social-post__author">
                    ...
                    <strong>Efe-Oghene Development Foundation</strong>
                  </div>
