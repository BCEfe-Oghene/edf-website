...
<p className="section-subtitle">
  Efe-Oghene Development Foundation designs and implements sustainable programmes that improve lives through education, WASH, healthcare, humanitarian response, research, and community empowerment across Nigeria.
</p>
        </div>
          ...
          {programs.map((program, index) => (
            <Link to={program.href} key={program.label} className="program-card">
              <div className="program-card__content">
                <span className="program-card__status" style={{ color: index === 0 ? '#0254a4' : 'var(--primary-blue)', borderColor: index === 0 ? '#0254a4' : 'var(--primary-blue)' }}>CORE PROGRAMME</span>
