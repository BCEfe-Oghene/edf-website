    ...
    <main className="contact-page">
          ...
          <div className="contact-info">
            ...
            <div className="info-item">
              ...
              <div>
                ...
                <p>NO.6 Ben Ayade Crescent, Jahi Abuja.<br/>FCT, Nigeria.<br/>Postal Code: 900108</p>
              </div>
            </div>
            ...
            <div className="info-item">
              ...
              <div>,
                ...
                <p><a href="mailto:info@edffoundation.org">info@edffoundation.org</a><br/><a href="mailto:donor.support@edffoundation.org">donor.support@edffoundation.org</a></p>
              </div>
            </div>
            ...
            <div className="info-item">
              ...
              <div>
                ...
                <p><a href="tel:+2347032860750">+2347032860750</a><br/>Fax: +92 21 3660 2013</p>
              </div>
            </div>
      ...
      <section className="map-section">
        <iframe 
          ...
          title="Efe-Oghene Development Foundation Office Location"
        ></iframe>
      </section>
      ...
      <section className="directory-section container">
        ...
        <div className="directory-grid">
          ...
          <div className="directory-card">
            ...
            <ul className="dir-links">
              <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"></path></svg> +234 70 328 6 07 50 (Ext: 105)</li>
              <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg> donor.support@edffoundation.org</li>
              <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> Mon - Fri: 9:00 AM - 5:00 PM</li>
            </ul>
          </div>
          ...
          <div className="directory-card">
            ...
            <ul className="dir-links">
              <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"></path></svg> +234 70 328 6 07 50 (Ext: 150)</li>
